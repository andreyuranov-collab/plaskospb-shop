# PLASKO SPB shop v00.08 test 260707

## Версия v00.08 test 260707

Главная страница переведена в минималистичный режим: после хедера сразу начинается каталог. Hero/промо-блок и блок преимуществ на главной отсутствуют.



Тестовая статическая версия интернет-магазина под GitHub + Cloudflare Pages.

Ключевое изменение v00.08: содержательно сохранены правки v00.06, но архив снова упакован с верхней папкой версии `plaskospb_shop_v00_07_test_260707`, чтобы при распаковке сразу появлялась отдельная папка проекта.
